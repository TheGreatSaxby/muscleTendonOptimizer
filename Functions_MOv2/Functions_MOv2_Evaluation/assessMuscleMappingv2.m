...
function Results_MusMapMetrics = assessMuscleMappingv2(Template_osimModel,...
                                                    Opt_osimModel, N_eval,N_error)
...
for n_mus = 0:muscles_ref.getSize()-1
    ...
    Lm_Norm_Templ = SampleMuscleQuantities(Template_osimModel,currentMuscle_Templ,'LfibNorm', N_error); 

    % Normalized fiber lengths for the optimized model
    Lm_Norm_Opt = SampleMuscleQuantities(Opt_osimModel,currentMuscle_Opt,'LfibNorm', N_error); 
